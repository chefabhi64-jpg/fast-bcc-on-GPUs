...
struct BCC {
  ...
  auto biconnectivity() {
    ...
    std::cout << "Eulerian Tour time: " << dur << " ms." << std::endl;
    ...
    dur = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
    std::cout << "Tagging Computation time: " << dur << " ms." << std::endl;
  ...
  auto get_articulation_point(const sequence<NodeId> &label) {
    ...
    auto end = std::chrono::high_resolution_clock::now();
    auto dur = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
    std::cout << "Getting Cut Vertex info time: " << dur << " ms." << std::endl;
  ...
  void get_num_bcc(const sequence<NodeId> &label) {
    ...
    auto end = std::chrono::high_resolution_clock::now();
    auto dur = std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count();
    std::cout << "Getting BCC Count time: " << dur << " ms." << std::endl;
