...
void undirected_graph::readEdgeList() {
    ...
    CUDA_CHECK(cudaMallocManaged((void**)&h_edgelist, bytes), "Failed to allocate pinned memory for edgelist");
...
undirected_graph::~undirected_graph() {
    if (h_edgelist) CUDA_CHECK(cudaFree(h_edgelist), "Failed to free pinned memory for h_edge_list");
