...
double solveQ_max(int m, int* d_na, int q, int* d_left, int* d_right, int* d_ansmax , int* d_a , int n) {
...
double main_max(int n, int q, int* d_a, int* d_left, int* d_right, int* d_ansmax, int n_asize, int* d_na) {
    ...
    dur += solveQ_max(n_asize, d_na, q, d_left, d_right, d_ansmax , d_a , n);
